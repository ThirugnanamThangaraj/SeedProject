...
Param(
    ...
    [string] $ResourceGroupName = 'SSDocProcessor',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'Templates\azuredeploy.central.json',
    [string] $TemplateParametersFile = 'Templates\azuredeploy.central.parameters.json',
...
if ($UploadArtifacts) {
    ...
    if($StorageAccount -eq $null){
		Write-Error "Storage Account not Accessibile"
		return 
    }
...
if ($ErrorMessages)
{
	...
	throw "Error in Resource Group Deployment. Please Try Again or Restart service and do try."
}
